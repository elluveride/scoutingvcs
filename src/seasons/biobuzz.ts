...
export const biobuzz: SeasonConfig = {
  ...
  counters: [
    ...
    { key: 'auto_fouls_minor', label: 'Minor Fouls', phase: 'auto', min: 0, hint: '5 pts to the opponent',
      pointsEach: BIOBUZZ_POINTS.MINOR_FOUL, role: 'foul_minor' },
    { key: 'auto_fouls_major', label: 'Major Fouls', phase: 'auto', min: 0, hint: '20 pts to the opponent',
